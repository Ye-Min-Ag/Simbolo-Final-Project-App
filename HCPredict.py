...
if uploaded_file is not None:
    ...
    st.header('Overall, due to limitations, prediction patterns didn\'t cope with true values as there are irregularities and lack of cleanliness in data, which in turn lead to influencing features and incorrect weights.')
